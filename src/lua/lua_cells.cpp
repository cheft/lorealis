...
void LuaManager::registerCellBindings(sol::table& brls_ns) {
    ...
    detail_cell_ut.set_function("onClick", [](brls::DetailCell& self, sol::protected_function func) {
    ...
    boolean_cell_ut.set_function("init", [](brls::BooleanCell& self, const std::string& title, bool value, sol::protected_function cb) {
    ...
    boolean_cell_ut.set_function("onClick", [](brls::BooleanCell& self, sol::protected_function func) {
        self.registerClickAction([func](brls::View* v) -> bool {
            auto result = func(v);
    ...
    slider_cell_ut.set_function("init", [](brls::SliderCell& self, const std::string& title, float value, sol::protected_function cb) {
    ...
    slider_cell_ut.set_function("getSlider", [](brls::SliderCell& self) { return self.slider; });
    ...
    radio_cell_ut.set_function("onClick", [](brls::RadioCell& self, sol::protected_function func) {
        self.registerClickAction([func](brls::View* v) -> bool {
            auto result = func(v);
    ...
    selector_cell_ut.set_function("init", [](brls::SelectorCell& self, const std::string& title, sol::table options, int selected, sol::protected_function onHighlight, sol::protected_function onSelect) {
    ...
    input_cell_ut.set_function("init", [](brls::InputCell& self, const std::string& title, const std::string& value, sol::protected_function cb, const std::string& placeholder, const std::string& hint, sol::optional<int> maxInputLength) {
    ...
    input_cell_ut.set_function("openKeyboard", [](brls::InputCell& self, sol::optional<int> maxInputLength) -> bool {
    ...
    input_numeric_cell_ut.set_function("init", [](brls::InputNumericCell& self, const std::string& title, long value, sol::protected_function cb, const std::string& hint) {
    ...
    slider_ut.set_function("onProgressChange", [](brls::Slider& self, sol::protected_function func) {
